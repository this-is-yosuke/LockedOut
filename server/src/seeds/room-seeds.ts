...
export const seedRoom = async () => {
    await Room.bulkCreate([
        ...
        /* Type = number OR letter. Type was added with the lock type in mind; some combinations use letter, while
           others use numbers. */
        {title: 'Ancient Crypt', description: 'Solve spooky riddles to escape this tomb.', type: 'number', difficulty: 3, creatorID: 1},
        {title: 'Lost in Space', description: 'Complete these sci-fi riddles to escape the alien spacecraft!', type: 'number', difficulty: 2, creatorID: 2},
