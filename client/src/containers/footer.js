...
const Footer = () => {
    return (<footer className="bg-stone-900 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <FooterSection title="About Us" content="Experience a thrilling solo virtual escape room that will challenge your mind. Solve puzzles, uncover secrets, and escape before time runs out!"/>
          <FooterSection title="Quick Links" content={<ul className="space-y-2">
          ...
          <FooterSection title="Follow Us" content={<SocialMediaIcons />}/>
          <FooterSection title="Contact Us" content={<div>
