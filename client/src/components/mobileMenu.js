...
const MobileMenu = () => {
    ...
    return (<div className="space-y-1 px-2 pt-2 pb-3 sm:hidden" id="mobile-menu">
      ...
      <a href="/#try" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
        Try A Room
      </a>
      ...
      {!user ? (<>
          ...
          <button onClick={logout} // Call logout function when clicked
